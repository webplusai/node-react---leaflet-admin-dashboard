...
function LocationTypeDelete({ itemID, onDelete }) {
  return (
    <div className="row">
      <div className="col-lg-12">
        <div className="panel panel-danger">
          ...
          <div className="panel-body">
            <LinkTo url={`locationTypes/${itemID}`}>LocationType #{itemID}</LinkTo>
          </div>
        </div>
...
LocationTypeDelete.propTypes = {
  itemID: PropTypes.string.isRequired,
  onDelete: PropTypes.func.isRequired
};

export default LocationTypeDelete;